...
export const gitWorkflow: DevSheet = {
  ...
  badge: "Fiche T05 — Vision Systémique",
  status: "Modèle stabilisé",
  meta: ["7 nœuds", "7 sections / nœud"],
  category: "Technique",
  level: "Junior",
  readingTime: "30 min",
  description:
  ...
  maps: {
    workflow: {
      ...
      edges: [
        ...
        { x1: 285, y1: 88, x2: 333, y2: 135 },
        { x1: 275, y1: 207, x2: 333, y2: 160 },
        { x1: 455, y1: 135, x2: 508, y2: 88 },
        { x1: 455, y1: 160, x2: 508, y2: 207 },
        { x1: 620, y1: 88, x2: 678, y2: 135 },
        { x1: 620, y1: 207, x2: 678, y2: 160 }
      ]
    }
  }
};
