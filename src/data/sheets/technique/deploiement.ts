...
export const deploiement: DevSheet = {
  ...
  title: "Déploiement",
  subtitle:
    "Passer d'un projet qui marche localement à un système qui tourne pour de vrais utilisateurs",
  badge: "Fiche T10",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Build frontend",
              description: "Bundle statique optimisé : dist/, .next/, assets hashés.",
            },
            {
              name: "Build backend",
              description: "TypeScript compilé, dépendances prod, image Docker.",
            },
            {
              name: "Artefact immuable",
              description: "Ce qui est testé est exactement ce qui est déployé.",
            },
          ],
        },
        ...
        choice: {
          ...
          alternatives: [
            ...
            { name: "GitHub Secrets", description: "Pour CI/CD et déploiements automatisés." },
            {
              ...
              description: "Doppler, Vault, AWS SSM pour environnements multiples.",
            },
          ],
        },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Vercel / Netlify",
              description: "Excellent pour frontend et apps JS orientées edge/serverless.",
            },
            {
              name: "Render / Railway / Fly.io",
              description: "Bon défaut pour backend Node/Python avec services managés.",
            },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "Release tags",
              description: "Plus contrôlé, utile quand chaque version compte.",
            },
    ...
    "prod-logs": {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "stdout plateforme",
              description: "Défaut simple, souvent suffisant au début.",
            },
            {
              name: "Logs structurés JSON",
              description: "Filtrables, corrélables, adaptés production.",
            },
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "Une erreur volontaire apparaît dans les logs avec stack trace et requestId",
            },
          ],
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "APM",
              description: "Datadog/New Relic/OpenTelemetry pour traces et performance.",
            },
          ],
        },
    ...
    rollback: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Redéployer commit précédent",
              description: "Simple si artefacts et variables sont stables.",
            },
            {
              name: "Rollback plateforme",
              description: "Vercel/Render/Fly peuvent garder des releases précédentes.",
            },
            {
              name: "Forward fix",
              description: "Corriger en avançant quand rollback DB est risqué.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "Identifier commit actuel, migration incluse, procédure rollback",
            },
          ],
