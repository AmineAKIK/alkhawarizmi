        ...
        choice: {
          ...
          alternatives: [
            { name: "git init", description: "Nouveau projet local à créer depuis zéro." },
            {
              name: "git clone",
              description:
                "Projet existant sur GitHub. À privilégier dès qu'un remote existe déjà.",
            },
            {
              name: "Monorepo",
              description:
                "Plusieurs projets liés dans un seul dépôt, utile quand l'écosystème grandit.",
            },
          ],
        },
          ...
          commands: [
            {
              type: "cmd",
              value:
                "git init -b main                                    # nouveau projet, branche main",
            },
            {
              type: "cmd",
              value: "git clone git@github.com:user/repo.git              # projet existant (SSH)",
            },
            {
              type: "cmd",
              value:
                "git remote add origin git@github.com:user/repo.git  # lier un init local à GitHub",
            },
            {
              type: "cmd",
              value:
                "git remote -v                                       # vérifier la connexion remote",
            },
            { type: "comment", value: "Vérification : ls -la → doit voir un dossier .git/" },
          ],
          verification:
            "ls -la doit montrer un dossier .git/, et git remote -v doit afficher le remote dès qu'il est connecté.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Template stack",
              description: "Base sûre pour JavaScript, Python, IDE et OS courants.",
            },
            { name: "Manuel", description: "Possible, mais plus risqué au début." },
            {
              name: "Global personnel",
              description: "Pour les fichiers de machine qui ne concernent pas le projet.",
            },
          ],
        },
        ...
        practice: {
          ...
          verification:
            "git status ne doit pas lister node_modules, .venv, .env ou des fichiers de build comme fichiers non suivis.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "Convention framework",
              description: "À suivre par défaut pour éviter la friction.",
            },
          ],
        },
        ...
        practice: {
          ...
          verification:
            "La racine doit rester lisible, et un nouveau fichier doit avoir un emplacement évident sans demander au hasard.",
    ...
    readme: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Minimaliste complet",
              description: "Description, prérequis, installation, lancement, env vars.",
            },
            { name: "docs/", description: "Documentation longue séparée du README." },
            {
              name: "Site docs",
              description: "MkDocs ou Docusaurus quand la doc devient un produit.",
            },
          ],
        },
        ...
        practice: {
          ...
          verification:
            "La page GitHub du dépôt doit afficher un README utile avec prérequis, installation, lancement et variables d'environnement.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "Secrets plateforme",
              description: "Vercel, Railway, Docker, GitHub Actions en production.",
            },
            {
              name: "Vault / Doppler",
              description: "Gestion avancée quand les environnements se multiplient.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "snippet",
              value: "DATABASE_URL=postgresql://user:password@localhost:5432/dbname",
            },
          ...
          verification:
            ".env doit être ignoré par Git, et .env.example doit lister toutes les variables nécessaires sans vraie valeur sensible.",
      ...
      sections: {
          ...
          alternatives: [
            {
              ...
              description: "Standard recommandé, automatisable et lisible.",
            },
            { name: "Gitmoji", description: "Fun, mais moins lisible pour CI/changelog." },
            {
              name: "Format maison",
              description: "Possible, mais demande discipline et outillage.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "npm install --save-dev @commitlint/cli @commitlint/config-conventional husky",
            },
            { type: "cmd", value: "npx husky init" },
          ],
          verification:
            "Un commit invalide doit être rejeté si commitlint est configuré, et git log --oneline doit rester lisible.",
    ...
    "package-json": {
      ...
      sections: {
        ...
        practice: {
          ...
          verification:
            "package.json doit contenir scripts, dependencies/devDependencies, engines si la version Node est importante, et un lock file commité.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "yarn",
              description: "Pertinent pour certains workspaces et projets existants.",
            },
          ],
        },
        ...
        practice: {
          ...
          verification:
            "node_modules doit exister localement, le lock file doit être présent, et un seul gestionnaire doit avoir généré un seul lock file.",
      ...
      sections: {
        ...
        practice: {
          commands: [
            {
              type: "cmd",
              value: "npm install --save-dev eslint prettier eslint-config-prettier @eslint/js",
            },
            { type: "comment", value: ".prettierrc" },
            {
              type: "snippet",
              value: `{ "semi": true, "singleQuote": true, "tabWidth": 2, "trailingComma": "es5", "printWidth": 100 }`,
            },
          ...
          verification:
            "npm run lint doit passer sur un fichier propre, et npm run format doit produire un formatage stable sans conflit ESLint/Prettier.",
    ...
    venv: {
      ...
      sections: {
        ...
        practice: {
          ...
          verification:
            "which python doit pointer vers .venv après activation, et .venv doit être ignoré par Git.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "pip-tools",
              description: "Sépare dépendances directes et versions compilées.",
            },
        ...
        practice: {
          ...
          verification:
            "pip install -r requirements.txt dans un venv vierge doit installer le projet sans dépendance manquante.",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "flake8 + autopep8 + isort",
              description: "Ancienne approche, plus fragmentée.",
            },
          ],
        },
        ...
        practice: {
          ...
          verification:
            "ruff check . et black --check . doivent passer sur un code propre, avec une configuration centralisée dans pyproject.toml.",
