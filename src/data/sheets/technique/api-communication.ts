      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "GraphQL",
              description: "Client choisit la forme des données, utile pour interfaces complexes.",
            },
        ...
        practice: {
          commands: [
            { type: "cmd", value: "curl -i http://localhost:3000/api/v1/health" },
            {
              type: "cmd",
              value:
                "curl -X POST http://localhost:3000/api/v1/users -H 'Content-Type: application/json' -d '{\"email\":\"a@b.com\"}'",
            },
    ...
    rest: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "REST resource-oriented",
              description: "Défaut simple : /users, /orders, /products.",
            },
            {
              name: "RPC/action",
              description: "Pour actions métier difficiles à modéliser en ressource.",
            },
            {
              name: "GraphQL",
              description: "Quand le problème principal est la forme des données côté client.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "curl -i 'http://localhost:3000/api/v1/users?limit=20&offset=0'",
            },
          ],
      ...
      sections: {
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "const api = axios.create({ baseURL: '/api/v1', timeout: 10000 })",
            },
      ...
      sections: {
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "app.use(cors({ origin: process.env.CORS_ORIGIN, credentials: true }))",
            },
            { type: "comment", value: "FastAPI" },
            {
              type: "cmd",
              value: "app.add_middleware(CORSMiddleware, allow_origins=[settings.frontend_url])",
            },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "Retry",
              description: "Utile pour erreurs temporaires et requêtes idempotentes.",
            },
            {
              name: "Fallback",
              description: "Dégradation contrôlée si un service est indisponible.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "comment",
              value: "Tester : couper le backend puis vérifier l'état d'erreur UI",
            },
          ],
