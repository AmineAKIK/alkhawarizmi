      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            {
              name: "Vitest / Jest",
              description: "Runner, assertions, mocks et coverage côté JavaScript.",
            },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "DB integration",
              description: "Tester repositories et migrations sur vraie base de test.",
            },
            {
              name: "Contract integration",
              description: "Vérifier qu'un client et une API respectent le même contrat.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            ...
            {
              type: "cmd",
              value: "await request(app).post('/api/v1/users').send(payload).expect(201)",
            },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "Fake",
              description: "Implémentation légère, souvent plus réaliste qu'un mock.",
            },
          ],
        },
        ...
        practice: {
          commands: [
            { type: "comment", value: "Factory JS" },
            {
              type: "cmd",
              value:
                "const buildUser = (overrides = {}) => ({ id: 1, email: 'a@test.com', ...overrides })",
            },
        ...
        choice: {
          ...
          alternatives: [
            ...
            { name: "Branch coverage", description: "Vérifie les chemins if/else." },
            {
              ...
              description: "Plus avancé : vérifie si les tests détectent des mutations.",
            },
          ],
        },
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            ...
            {
              name: "CI locale",
              description: "npm test / pytest avant commit, complément seulement.",
            },
          ],
        },
