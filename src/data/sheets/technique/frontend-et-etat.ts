...
export const frontendEtEtat: DevSheet = {
  ...
  badge: "Fiche T08 — Vision Systémique",
  status: "Modèle stabilisé",
  meta: ["7 nœuds · frontend", "7 sections / nœud"],
  category: "Technique",
  level: "Junior",
  readingTime: "35 min",
  description:
  ...
  maps: {
    frontend: {
      ...
      edges: [
        { x1: 140, y1: 135, x2: 188, y2: 88 },
        { x1: 140, y1: 160, x2: 188, y2: 207 },
        { x1: 300, y1: 88, x2: 358, y2: 135 },
        { x1: 310, y1: 207, x2: 358, y2: 160 },
        { x1: 490, y1: 135, x2: 548, y2: 88 },
        { x1: 490, y1: 160, x2: 548, y2: 207 },
        { x1: 660, y1: 88, x2: 718, y2: 135 },
        { x1: 660, y1: 207, x2: 718, y2: 160 }
      ]
    }
  }
};
