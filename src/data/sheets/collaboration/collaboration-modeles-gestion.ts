...
export const collaborationModelesGestion = coSheet({
  ...
  meta: ["5 nœuds"],
  readingTime: "30 min",
  description: "Cascade, itératif, spirale, Kanban, hybride : chaque modèle répond à une famille de contraintes. Cette fiche cartographie les forces, les zones de rupture et les critères de choix concrets pour un projet logiciel.",
  accent: "organisation",
  nodes: {
    cascade: coNode({
      id: "cascade",
      ...
      practice: {
        ...
        items: [{
          ...
          critere: "Les chevauchements doivent avoir une cause identifiée (exigences floues, validation absente, etc.) — pas juste une durée.",
        }],
        piege: "Confondre 'on avait un brief' avec 'les exigences étaient stables' — un brief n'est pas une spec validée.",
      },
      verification: [
    ...
    iteratif: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Liste de tâches estimées + 3 retours documentés + ajustements pour la prochaine itération.",
          critere: "Les ajustements doivent être formulés en critères vérifiables, pas en intentions ('améliorer la UI' n'est pas un critère).",
        }],
        piege: "Vouloir que la fonctionnalité soit 'finie' avant de montrer — l'itératif fonctionne sur du partiel fonctionnel, pas sur du parfait caché.",
      },
      verification: [
    ...
    spirale: coNode({
      ...
      system: "Le modèle en spirale organise le projet en cycles de quatre quadrants : définir les objectifs → identifier et réduire les risques → développer et tester → planifier le cycle suivant. <span class=\"ref-fiche\">→ Co04</span> : chaque cycle spirale implique une revue de risque avec les parties prenantes — la communication structurée y est critique. <span class=\"ref-fiche\">→ Co09</span> : les méthodes agiles ont absorbé l'esprit de la spirale (feedback, itération, adaptation) sans en conserver le formalisme de l'analyse de risque explicite.",
      choice: "La spirale est adaptée aux projets à haute incertitude technique (nouveaux algorithmes, intégrations inconnues, systèmes critiques), aux grands projets où les risques non traités coûtent très cher, ou quand le client accepte un processus formel de validation par cycle. Elle est surdimensionnée pour des projets web classiques de 3 mois — son overhead de documentation et de revue de risque dépasse les bénéfices.",
      senior: "La spirale est souvent mal comprise comme 'une cascade avec des tours'. Son cœur c'est : 'qu'est-ce qui peut tuer ce projet, et comment le valider au plus tôt ?' Un senior applique l'esprit de la spirale sans le formalisme : dans les deux premières semaines de tout projet, il identifie les 3 risques techniques qui pourraient tout faire capoter, et il crée des spikes (prototypes d'investigation) pour les réduire avant de planifier quoi que ce soit d'autre.",
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Matrice de risques avec scores avant/après spikes et décision de planification.",
          critere: "Les scores doivent avoir baissé ou la décision de reporter doit être argumentée — 'on a fait le spike et le risque reste rouge' est un résultat valide.",
        }],
        piege: "Traiter tous les risques au lieu des deux ou trois qui peuvent vraiment tuer le projet.",
      },
      verification: [
    ...
    kanban: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Tableau avec WIP limit définie + nombre de tickets complétés semaine 1 vs semaine avant.",
          critere: "Moins de tickets complétés après une semaine est un signal valide — ça révèle un goulot, pas un échec de la méthode.",
        }],
    ...
    hybride: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          critere: "Les règles doivent être binaires et applicables sans ambiguïté — 'si un jalon contractuel est dans les 3 semaines, on gèle le scope' est une règle ; 'on s'adapte au contexte' n'en est pas une.",
        }],
        piege: "Croire qu'une bonne charte suffit — les conflits de mode viennent des incitations organisationnelles, pas du manque de documentation.",
      },
      verification: [
