...
export const collaborationDefisCollaboration = coSheet({
  ...
  subtitle: "Gouvernance, durabilité, burnout des mainteneurs et tendances — ce qui menace et transforme le collaboratif",
  badge: "Fiche Co16",
  meta: ["5 nœuds"],
  readingTime: "30 min",
  description: "Les ressources collaboratives ne sont pas pérennes par nature — elles reposent sur des personnes qui donnent du temps, des organisations qui contribuent, et des modèles économiques qui tiennent rarement sur le long terme. Cette fiche couvre les défis structurels (burnout, gouvernance, financement) et les évolutions qui redessinent le paysage collaboratif en informatique.",
  accent: "humain",
  nodes: {
    burnoutMainteneurs: coNode({
      ...
      system: "Le burnout des mainteneurs est la manifestation humaine du déséquilibre entre consommation et contribution dans les ressources collaboratives. <span class=\"ref-fiche\">→ Co14</span> : l'audit de santé des dépendances (mainteneurs actifs, fréquence des commits) permet de détecter les projets à risque avant qu'ils ne s'effondrent. <span class=\"ref-fiche\">→ Co15</span> : les bonnes pratiques de contribution (reports de bugs bien formés, PRs ciblées, sponsoring) sont les réponses concrètes que chaque équipe peut apporter à ce problème.",
      choice: "Réponses individuelles vs. réponses systémiques. Individuellement : sponsoriser financièrement les projets critiques (GitHub Sponsors, Open Collective), contribuer du code ou de la documentation, réduire le bruit (issues bien formées, pas de 'quand est-ce que ça sort ?'). Systémiquement : encourager les entreprises qui s'appuient sur l'open source à allouer du temps de développement à la contribution (modèle de Red Hat, Google, Microsoft avec des dizaines d'employés contributeurs open source). La décision pour une petite équipe : identifier les 3 dépendances les plus critiques et les sponsoriser même modestement — 10€/mois par projet est réaliste et a un impact réel pour un mainteneur solo.",
      senior: "Le signe qu'un projet est en burnout avant l'effondrement : les issues restent sans réponse plus de 3 mois, les PRs mergent de plus en plus lentement, le ton du mainteneur dans les issues devient plus sec. Ces signaux précèdent l'abandon de 6 à 12 mois. Un développeur expérimenté surveille ces signaux sur ses dépendances critiques et prépare des alternatives avant que l'urgence ne s'impose. La migration planifiée coûte 10 fois moins cher que la migration forcée.",
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Audit de 5 dépendances critiques + plan de sponsoring soumis + alternative documentée pour la plus fragile.",
          critere: "Le plan B doit être assez détaillé pour être exécutable en une semaine — 'migrer vers X' n'est pas un plan ; 'remplacer les 3 points d'intégration A, B, C par l'API de X selon la doc de migration' en est un.",
        }],
        piege: "Ne considérer que les dépendances directes — les dépendances transitives (dépendances de vos dépendances) sont souvent encore moins maintenues et tout aussi critiques.",
      },
      verification: [
    ...
    gouvernanceOuvertes: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Document de gouvernance d'une page + analyse de 3 décisions passées reformulées avec le processus.",
          critere: "Le document doit être opérationnel : une personne qui rejoint le projet doit pouvoir comprendre comment proposer et faire accepter un changement sans demander à quelqu'un.",
        }],
        piege: "Sur-formaliser pour un petit projet — une page de CONTRIBUTING.md est suffisante pour un projet de 3 contributeurs ; une fondation ne l'est pas.",
      },
      verification: [
    ...
    financementDurable: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Calcul de ROI de 3 dépendances critiques + email de demande de sponsoring rédigé et envoyé.",
          critere: "Le calcul de ROI doit être suffisamment documenté pour être présenté à quelqu'un qui ne connaît pas le sujet — hypothèses explicites, chiffres justifiés.",
        }],
        piege: "Attendre que quelqu'un d'autre prenne l'initiative — la proposition de financement doit venir de quelqu'un qui comprend la valeur de la dépendance, c'est-à-dire vous.",
      },
      verification: [
    ...
    evolutionsTendances: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Analyse de la tendance avec retours d'expérience réels + critère de maturité documenté.",
          critere: "Le critère de maturité doit être vérifiable objectivement — 'quand c'est assez stable' n'est pas un critère, 'quand la lib a une version 1.0 et 6 mois d'historique de releases' en est un.",
        }],
        piege: "Évaluer une tendance sur ses promesses plutôt que sur les retours d'expérience de ceux qui l'utilisent en production — les annonces et les retours réels divergent souvent significativement.",
      },
      verification: [
    ...
    problematiquesSurmonter: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Audit d'accessibilité du projet + une contribution concrète (issue ou PR) pour réduire une barrière identifiée.",
          critere: "La contribution doit s'attaquer à une barrière mesurable — pas 'la communauté pourrait être plus accueillante' (non mesurable) mais 'le CONTRIBUTING.md ne dit pas comment lancer les tests en local' (spécifique et corrigeable).",
        }],
        piege: "Confondre 'la communauté est gentille avec moi' avec 'la communauté est accessible à tous' — votre expérience peut être non représentative de celle d'un contributeur venant d'un contexte différent.",
      },
      verification: [
