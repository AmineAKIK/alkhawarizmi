...
export const collaborationDocumentation = coSheet({
  ...
  subtitle: "Capturer le pourquoi, maintenir la mémoire collective et éviter que la doc devienne une dette.",
  badge: "Fiche Co03 — Vision Systémique",
  ...
  nodes: {
    ...
    docCommeDette: coNode({
      ...
      system: "La dette documentaire suit la dette technique. Elle doit être traitée dans les reviews, la Definition of Done et les processus d'équipe.",
      choice: "Inclure la doc dans la Definition of Done, la co-localiser avec le code, et tester les exemples quand c'est possible.",
      senior: "Il rend la fraîcheur visible: propriétaire, dernière révision, zone de validité. Une doc sans signal de fraîcheur devient suspecte même quand elle est vraie. Il préfère supprimer une page trompeuse plutôt que laisser une équipe perdre deux heures à suivre une procédure morte.",
    ...
    quoiDocumenter: coNode({
      ...
      practice: { kind: "exercices", items: [{
        ...
        critere: "Quelqu'un qui arrive dans 2 ans doit comprendre pourquoi le système est ainsi.",
      }], piege: "Réserver les ADRs aux très grandes décisions. Les petites conventions répétées méritent aussi mémoire." },
      verification: [
    ...
    documentationCode: coNode({
      ...
      system: "Elle vit dans commentaires, commits, descriptions de PR, docstrings et conventions de review.",
      choice: "Commentaires pour le pourquoi, commits pour le changement, PR pour la décision, docstrings pour l'interface publique.",
      senior: "Il traite commit, description de PR et commentaire inline comme trois couches de mémoire. Le commit explique le changement durable, la PR explique le contexte de décision, le commentaire explique le pourquoi local que le code ne peut pas porter. Il supprime les commentaires qui mentent avec autant d'énergie qu'il corrige un test rouge.",
      ...
      practice: { kind: "exercices", items: [{
        ...
        critere: "Si un meilleur nommage remplace le commentaire, corrige le code plutôt que d'ajouter du texte.",
    ...
    culturedoc: coNode({
      ...
      system: "La culture documentaire dépend de la confiance, du leadership, de la Definition of Done et du temps réellement alloué.",
      choice: "Traiter la doc comme first-class citizen, voir les leaders documenter, valoriser publiquement les contributions à la documentation.",
      senior: "Il regarde les signaux réels, pas les slogans: est-ce que les estimations incluent la doc, est-ce que les reviews bloquent une décision non documentée, est-ce qu'une contribution doc est célébrée comme une contribution produit ? La culture change quand le comportement attendu coûte ou rapporte quelque chose dans le système.",
      ...
      practice: { kind: "exercices", items: [{
        ...
        critere: "Une action doit être spécifique: par exemple ajouter une question doc à chaque review cette semaine.",
