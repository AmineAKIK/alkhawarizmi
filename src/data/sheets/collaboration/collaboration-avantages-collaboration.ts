    ...
    gainsReels: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Tableau ROI : temps économisé (implémentation + maintenance) vs. temps investi (intégration + migration) + gain net en jours/an.",
          critere: "Les estimations doivent être documentées avec des hypothèses explicites — 'j'estime X parce que...' — pas juste des chiffres.",
        }],
        piege: "N'inclure que le coût d'implémentation initial dans le calcul — le coût de maintenance long terme est souvent 3 à 5 fois supérieur au coût initial.",
      },
      verification: [
    ...
    bonnesPratiquesContribution: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "PR ouverte sur un vrai projet open source avec description complète, référence à l'issue et changements minimaux.",
          critere: "La PR doit être assez petite pour être reviewée en moins de 15 minutes. Si elle dépasse 100 lignes de changements pour une première contribution, elle est trop grande.",
        }],
        piege: "Choisir un bug complexe ou une feature impressionnante pour la première contribution — les 'good first issues' existent pour que les contributeurs apprennent le processus, pas pour prouver leur niveau.",
      },
      verification: [
    ...
    reutilisationSaine: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Wrapper créé + tous les imports remplacés + simulation de remplacement réussie en modifiant un seul fichier.",
          critere: "Le remplacement de la lib dans le wrapper ne doit nécessiter aucun changement en dehors du fichier wrapper — si d'autres fichiers doivent changer, l'encapsulation est incomplète.",
        }],
        piege: "Encapsuler toutes les dépendances par principe — réservez l'encapsulation aux dépendances avec une API instable ou appelées dans de nombreux endroits.",
      },
      verification: [
    ...
    liensCommonaute: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Carte de réseau de 10 personnes avec évaluation de la réciprocité + une action concrète réalisée.",
          critere: "L'action concrète doit être désintéressée — contribuer quelque chose sans rien demander en retour. Si vous cherchez un bénéfice immédiat, ce n'est pas de la réciprocité, c'est de l'échange commercial.",
        }],
        piege: "Chercher à augmenter la taille du réseau plutôt que la profondeur des liens — 10 relations réelles valent plus que 500 connections LinkedIn sans substance.",
      },
      verification: [
    ...
    optimisationUsage: coNode({
      ...
      practice: {
        ...
        items: [{
          ...
          output: "Liste de ressources supprimées (dépendances, communautés, bookmarks) + impact mesuré sur un indicateur concret.",
          critere: "L'audit doit aboutir à des suppressions réelles, pas seulement à des listes. Une suppression est meilleure qu'un plan de suppression.",
        }],
        piege: "Garder une ressource 'au cas où' — si elle n'a pas été utilisée en 3 mois et qu'il n'y a pas de projet concret prévu, le 'au cas où' est une rationalisation.",
      },
      verification: [
