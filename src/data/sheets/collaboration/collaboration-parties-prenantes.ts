...
export const collaborationPartiesPrenantes = coSheet({
  ...
  subtitle: "Cartographier, comprendre et naviguer les relations avec PM, designer, client et hiérarchie technique.",
  badge: "Fiche Co05",
  meta: ["7 nœuds"],
  readingTime: "45 min",
  description: "Les compétences relationnelles qui permettent à un développeur web de travailler efficacement avec chaque interlocuteur clé de son écosystème.",
  accent: "humain",
  nodes: {
        ...
        items: [
          {
            ...
            output: "Liste annotée de 5 à 10 stakeholders avec rôle, canal et fréquence pour les deux principaux.",
            critere: "Si un membre de ton équipe peut lire ta cartographie et identifier immédiatement qui appeler en cas de blocage, le travail est réussi.",
          },
        ],
        piege: "Ne cartographier que les personnes avec qui on parle déjà. Les oubliés dangereux sont précisément ceux qu'on n'a pas encore rencontrés.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "3 questions d'intention, leur impact sur l'implémentation et une estimation conditionnelle.",
            critere: "Le PM doit pouvoir lire tes questions et comprendre immédiatement quel risque tu essaies de lever.",
          },
        ],
        piege: "Poser des questions techniques au PM. Les questions utiles portent sur le comportement attendu de l'utilisateur, pas sur les détails d'implémentation.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "Liste des états manquants, 2 propositions d'alternative formulées en impact utilisateur.",
            critere: "Un designer sans background technique doit comprendre ta proposition sans que tu aies à expliquer le code.",
          },
        ],
        piege: "Attendre la fin de l'implémentation pour signaler les contraintes. Plus la contrainte est signalée tôt, plus le designer a d'options pour adapter la maquette.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "Besoin réel identifié, 2 alternatives formulées en langage métier avec leurs trade-offs.",
            critere: "Un responsable métier sans background technique doit pouvoir choisir entre tes alternatives en comprenant les implications.",
          },
        ],
        piege: "Trop interroger un client sur ses besoins profonds quand il a une contrainte de temps ou de budget : parfois la bonne solution c'est livrer ce qui est demandé et documenter ce qu'on a vu.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "Message d'escalade structuré : contexte, options considérées, décision demandée.",
            critere: "Le lead doit pouvoir répondre à ton message sans poser de question de clarification sur le contexte.",
          },
        ],
        piege: "Confondre visibilité et reporting bureaucratique. La visibilité est proactive et ciblée sur ce qui peut changer une décision; le reporting pour le reporting est du bruit.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "Journal de 5 échanges analysés + un désaccord formulé comme question + une demande d'aide structurée envoyée.",
            critere: "Le désaccord formulé comme question doit être suffisamment précis pour que ton collègue comprenne où tu vois le problème, sans que tu aies à dire 'tu as tort'.",
          },
        ],
        piege: "Croire que les tensions entre développeurs viennent de conflits de personnalité. La majorité vient de désaccords techniques non exprimés qui s'accumulent — la solution est plus souvent une conversation franche sur le code qu'un travail sur la relation.",
      },
      verification: [
        ...
        items: [
          {
            ...
            output: "Tableau de 5 retours : symptôme vs problème + 1 job to be done + 2 solutions orientées problème.",
            critere: "Tes deux solutions ne doivent pas être les features demandées par les clients — elles doivent résoudre le problème sous-jacent que tu as identifié, possiblement de façon différente.",
          },
        ],
        piege: "Traiter les retours de 5 utilisateurs comme représentatifs. Les utilisateurs qui donnent du feedback sont presque toujours ceux qui s'y connaissent le mieux ou qui sont le plus frustrés — ni l'un ni l'autre n'est le cas médian.",
      },
      verification: [
