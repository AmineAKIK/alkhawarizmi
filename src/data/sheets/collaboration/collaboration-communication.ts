...
export const collaborationCommunication = coSheet({
  ...
  badge: "Fiche Co02 — Vision Systémique",
  meta: ["5 nœuds · universel", "8 sections / nœud"],
  readingTime: "35 min",
  description: "La communication qui transforme une expertise technique en décisions comprises hors de l'équipe.",
  ...
  nodes: {
    translationTechnique: coNode({
      ...
      system: "Cette compétence alimente la gestion des attentes, les présentations, les mauvaises nouvelles et l'alignement stakeholder.",
      choice: "Pour un PM, parler impact feature et timeline. Pour un dirigeant, parler risque et ROI. Pour un designer, parler contraintes, alternatives et coût d'implémentation.",
      senior: "Avant d'expliquer, il identifie la décision que l'autre personne doit prendre. Un PM a besoin d'impact scope/délai, un dirigeant de risque/ROI, un designer de contraintes et alternatives. Il ne traduit pas tout: il choisit le niveau d'abstraction qui permet à l'interlocuteur d'agir sans croire comprendre plus qu'il ne comprend.",
      ...
      }], piege: "Confondre acquiescement et compréhension. La vraie mesure est la décision qui suit." },
      verification: [
    ...
    gererAttentes: coNode({
      ...
      system: "Cela dépend de bonnes estimations, de risques communiqués et d'un suivi régulier même quand tout va bien.",
      choice: "Under-promise avec prudence, communiquer les risques tôt, donner des mises à jour courtes et régulières pour réduire l'anxiété.",
      senior: "Il annonce l'incertitude avant qu'elle ne devienne une excuse. Il distingue estimation et engagement dans la même phrase: probabilité, hypothèses, signaux d'alerte et date de révision. Il sait qu'un retard annoncé tôt ressemble à du professionnalisme; le même retard annoncé à la deadline ressemble à une trahison.",
      ...
      }], piege: "Sur-communiquer chaque micro-incertitude. Un risque communiqué doit avoir un impact réel."},
      verification: [
    ...
    presentationTech: coNode({
      ...
      system: "Elle s'appuie sur la traduction technique et sert les décisions collectives, RFC, ADR et arbitrages.",
      choice: "SCQA pour les décisions, Pyramid principle pour les audiences pressées, demo-first pour ancrer dans le concret.",
      senior: "Il commence par la tension que l'audience reconnaît, puis révèle seulement les détails nécessaires à la décision. Il prépare la dernière slide avant la première: décision demandée, option recommandée, risque accepté. Si personne ne sait quoi faire après la présentation, ce n'était pas une présentation technique, c'était un transfert d'anxiété.",
      ...
      }], piege: "Faire un hybride document/présentation. Un slide accompagne la parole; un document doit vivre seul." },
      verification: [
    ...
    direBonneNouvelle: coNode({
      ...
      system: "Cette compétence complète la gestion des attentes et nourrit l'alignement stakeholder, surtout en contexte de tension.",
      choice: "Mauvaise nouvelle: directe, tôt, contextualisée, avec proposition. Bonne nouvelle: exacte, prouvée par des données, sans exagération.",
      senior: "Il prépare toujours la question implicite: qu'est-ce qu'on fait maintenant ? Il donne la mauvaise nouvelle assez tôt pour préserver des options, et assez directement pour éviter que l'autre doive la deviner. Il ne compense pas une mauvaise nouvelle par du flou positif: il compense par un plan.",
    ...
    alignementStakeholders: coNode({
      ...
      system: "L'alignement synthétise traduction, attentes, présentation, processus de décision et compréhension des parties prenantes.",
      choice: "Pré-alignement avant réunion, communication en cercles concentriques, et DACI pour clarifier les rôles décisionnels : Driver (coordonne le processus), Approver (décide finalement — une seule personne), Contributors (consultés pour leur expertise), Informed (notifiés du résultat).",
      senior: "Il sait que les grandes décisions se prennent rarement pendant la réunion finale. Avant, il cartographie intérêts, peurs et veto possibles, puis parle aux personnes clés une par une. La réunion sert à rendre visible un alignement déjà travaillé, pas à découvrir en public la première objection majeure.",
      ...
      practice: { kind: "exercices", items: [{
        ...
        critere: "Aucune objection majeure ne doit apparaître pour la première fois en réunion finale.",
      }], piege: "Confondre consultation et vote. Tout le monde peut être entendu sans avoir un veto." },
      verification: [
