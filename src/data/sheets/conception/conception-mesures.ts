...
export const conceptionMesures = conceptionSheet({
  ...
  badge: "Fiche C06 — Vision Systémique",
  meta: ["5 nœuds · universel"],
  readingTime: "25 min",
  description: "Choisir des métriques de substance, distinguer indicateurs précoces et tardifs, formuler des hypothèses testables, éviter les causalités naïves et boucler Build-Measure-Learn.",
  accent: "validation",
  nodes: {
    metriquesVanite: {
      id: "metriquesVanite",
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            { name: "Métrique de vanité", description: "Nombre total d'inscrits, pages vues, téléchargements. Utile pour raconter, insuffisant pour décider." },
            { name: "Métrique d'activation", description: "Mesure si l'utilisateur atteint le premier moment de valeur. Critique pour savoir si la promesse est comprise." },
            { name: "Métrique de rétention", description: "Mesure si la valeur est assez forte pour faire revenir. Souvent plus révélatrice que l'acquisition." },
            { name: "Métrique économique", description: "Conversion, ARPA, marge, CAC payback. Indispensable quand la question est la viabilité." },
          ],
        },
        ...
        practice: {
          exercices: [{
            ...
            output: "Une métrique de substance choisie, avec hypothèse associée, seuil et décision déclenchée.",
            critere: "Si la métrique peut monter pendant que les utilisateurs ne reçoivent pas plus de valeur, elle reste une métrique de vanité.",
          }],
          piege: "Choisir une métrique parce qu'elle est disponible dans l'outil d'analytics. La bonne métrique vient de l'hypothèse, pas du dashboard.",
        },
        verification: [
    ...
    leadingLagging: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            { name: "Lagging indicator", description: "Revenu, churn, rétention longue, renouvellement. Fiable mais tardif : bon pour juger, mauvais pour corriger vite." },
            { name: "Leading indicator", description: "Comportement précoce corrélé à la valeur future : activation, usage d'une feature clé, complétion d'un setup. Bon pour agir vite, à valider." },
            { name: "Proxy metric", description: "Approximation utilisée quand la valeur finale est difficile à mesurer. Utile seulement si le lien avec la valeur est testé régulièrement." },
          ],
        },
        ...
        practice: {
          exercices: [{
            ...
            output: "Une paire leading/lagging avec hypothèse de lien, méthode de vérification et action si le leading se dégrade.",
            critere: "Le leading indicator doit être observable avant le lagging et permettre une action concrète. Sinon il ne sert pas à piloter.",
          }],
    ...
    hypothesisDriven: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            { name: "Hypothèse de problème", description: "Nous croyons que ce segment souffre de cette douleur. À tester avant de parler de solution." },
            { name: "Hypothèse de solution", description: "Nous croyons que cette approche résout mieux le problème. À tester par MVP, prototype ou expérimentation." },
            { name: "Hypothèse de croissance", description: "Nous croyons que ce canal ou mécanisme amènera les bons utilisateurs. À tester avec coût et qualité d'acquisition." },
            { name: "Hypothèse économique", description: "Nous croyons que les utilisateurs ou acheteurs paieront selon ce modèle. À tester par engagement, prévente ou conversion." },
          ],
        },
        ...
        practice: {
          exercices: [{
            ...
            output: "Un hypothesis statement complet avec métrique, seuil, délai et décision post-test.",
            critere: "Quelqu'un doit pouvoir lire l'hypothèse et savoir quel résultat prouverait que la feature ne mérite pas d'être poursuivie.",
          }],
    ...
    correlationCausalite: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            { name: "Observation corrélationnelle", description: "Rapide, utile pour générer des hypothèses. Ne suffit pas pour prouver un effet." },
            { name: "Analyse de cohortes", description: "Compare des groupes dans le temps. Plus robuste, mais sensible aux biais de sélection." },
            { name: "Expérience contrôlée / A-B test", description: "Meilleur outil pour inférer un effet causal si le trafic et la randomisation sont suffisants." },
            { name: "Test qualitatif causal", description: "Entretiens ou observations pour comprendre le mécanisme. Ne prouve pas l'ampleur, mais révèle pourquoi l'effet pourrait exister." },
          ],
        },
        ...
        practice: {
          exercices: [{
            ...
            output: "Une corrélation analysée avec hypothèse causale, explications alternatives, test proposé et niveau de preuve requis.",
            critere: "Tu dois avoir au moins une explication alternative crédible. Si tu n'en trouves aucune, tu es probablement trop attaché à ton interprétation.",
          }],
          piege: "Croire qu'un graphique propre produit une conclusion propre. La causalité vient du design de preuve, pas de la beauté du dashboard.",
        },
        verification: [
    ...
    buildMeasureLearn: {
      ...
      sections: {
        ...
        choice: {
          ...
          alternatives: [
            { name: "Learn-Build-Measure", description: "Commencer par apprendre quand l'incertitude problème ou segment est forte. Entretiens, observation, tests sans produit." },
            { name: "Build-Measure-Learn", description: "Construire juste assez quand l'hypothèse est formulée et qu'un comportement réel doit être observé." },
            { name: "Measure-Learn-Build", description: "Commencer par mesurer quand un produit existe déjà et que les données peuvent révéler le prochain apprentissage." },
          ],
        },
        ...
        practice: {
          exercices: [{
            ...
            output: "Une boucle Build-Measure-Learn complète : hypothèse, build minimal, mesure, seuils, décisions et trace d'apprentissage.",
            critere: "La boucle est valide si elle peut changer une décision. Si le résultat ne changerait rien, l'expérience ne mérite pas d'être menée.",
          }],
          piege: "Confondre boucle d'apprentissage et sprint de livraison. Une livraison sans hypothèse ni décision associée n'est pas une boucle BML.",
        },
        verification: [
